        ...
        <div class="logo-advertisement">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="{{asset('page/images/logo.png')}}" alt=""></a>
                </div>
                                        ...
                                        <div class="posts-filtered-block">
                                            <div class="owl-wrapper">
                                                ...
                                                <div class="owl-carousel" data-num="4">
                                                    ...
                                                    <div class="item news-post standard-post">
                                                        <div class="post-gallery">
                                                            <img src="{{asset('page/upload/news-posts/art6.jpg')}}" alt="">
                                                        </div>
                                                        <div class="post-content">
                                                    ...
                                                    <div class="item news-post standard-post">
                                                        <div class="post-gallery">
                                                            <img src="{{asset('page/upload/news-posts/art9.jpg')}}" alt="">
                                                        </div>
                                                        <div class="post-content">
                                                            <h2><a href="single-post.html">Donec nec justo eget felis facilisis fermentum. </a></h2>
                                                            <ul class="post-tags">
                                        ...
                                        <div class="owl-wrapper">
                                            ...
                                            <div class="owl-carousel" data-num="4">
                                                ...
                                                <div class="item news-post video-post">
                                                    <img alt="" src="{{asset('page/upload/news-posts/video1.jpg')}}">
                                                ...
                                                <div class="item news-post video-post">
                                                    <img alt="" src="{{asset('page/upload/news-posts/video2.jpg')}}">
                                                    <a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
                                                    <div class="hover-box">
                                                ...
                                                <div class="item news-post video-post">
                                                    <img alt="" src="{{asset('page/upload/news-posts/video3.jpg')}}">
                                                    <a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
                                                    <div class="hover-box">
                                                ...
                                                <div class="item news-post video-post">
                                                    <img alt="" src="{{asset('page/upload/news-posts/video4.jpg')}}">
                                                    <a href="https://www.youtube.com/watch?v=LL59es7iy8Q" class="video-link"><i class="fa fa-play-circle-o"></i></a>
                                                    <div class="hover-box">
                                                        <h2><a href="single-post.html">Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</a></h2>
                                                        <ul class="post-tags">
