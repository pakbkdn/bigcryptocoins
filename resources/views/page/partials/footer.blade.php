            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="widget posts-widget">
                        ...
                        <ul class="list-posts">
                            <li>
                                <{{asset('page/img')}} src="{{asset('page/upload/news-posts/listw4.jpg')}}" alt="">
                ...
                <div class="col-md-3">
                    <div class="widget flickr-widget">
                        ...
                        <ul class="flickr-list">
                            <li><a href="#"><img src="{{asset('page/upload/flickr/1.jpg')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('page/upload/flickr/2.jpg')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('page/upload/flickr/3.jpg')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('page/upload/flickr/4.jpg')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('page/upload/flickr/5.jpg')}}" alt=""></a></li>
                            <li><a href="#"><img src="{{asset('page/upload/flickr/6.jpg')}}" alt=""></a></li>
                        </ul>
